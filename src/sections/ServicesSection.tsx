  ...
  return (
    <section id={id} style={{ background: "var(--belvo-bg)", overflow: "hidden" }}>
      ...
      <div
        id="services-grid"
        ref={gridRef}
        style={{ padding: "40px 24px 120px", position: "relative", overflow: "hidden", background: "var(--belvo-bg)" }}
      >
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto", position: "relative", zIndex: 1 }}>
          <motion.div custom={0} variants={fadeUp} initial="hidden" animate={gridInView ? "visible" : "hidden"} style={{ textAlign: "center", marginTop: "8px", marginBottom: "24px" }}>
